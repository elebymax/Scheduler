...
var formatData = function (lines) {
  ...
  var daysAttr = findHead(lines);
  var daysOrderList = daysAttr.daysOrderList; //需要考慮的標頭所在位置
  var daysNameList = daysAttr.daysNameList; //天數的名稱
  ...
  console.log(`countList: \n${ peopleAlreadyBeenShiftCountList }`);
